ActionController::Routing::Routes.draw do |map|
  ...
  map.system_groups_change_page  '/system_groups/system_groups_change_page/:page', :controller => 'system_groups', :action => 'system_groups_change_page'
