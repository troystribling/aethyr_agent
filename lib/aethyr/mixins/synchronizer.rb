    ...
    module Synchronizer
      ...
      module Model
        ...
        module ClassMethods 
          ...
          ######################################################################################################
          def synchronize(interface, supporter = nil, association_sync = true)
            self.synchronize_associations(supporter) if (self.respond_to?(:synchronize_associations) and association_sync)
